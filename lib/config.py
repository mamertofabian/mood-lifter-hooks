...
class Config:
    ...
    DEFAULT_CONFIG_PATHS = [
        ...
        Path(
            "/home/atomrem/projects/codefrost-dev/mood-lifter-hooks/config/defaults.json"
        ),  # Project directory
    ]
...
def test_config():
    ...
    sample_config = {
        "mood_lifter_hooks": {
            "lm_studio": {"use_variety": False, "preferred_models": ["llama-3.2-1b-instruct"]},
            "message_sources": {"weights": {"default": 60, "jw": 40}},
        }
    }
